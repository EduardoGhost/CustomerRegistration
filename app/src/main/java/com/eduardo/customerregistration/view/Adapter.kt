...
class Adapter(private val listClientes: List<ClienteEntity>) :
    RecyclerView.Adapter<Adapter.ClienteViewHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ClienteViewHolder {
        val listaDeClientes = LayoutInflater.from(parent.context).inflate(
    ...
    override fun onBindViewHolder(holder: ClienteViewHolder, position: Int) {
        val cliente = listClientes[position]
...
//        var activity: Context = itemView.context
        var nome: TextView = itemView.findViewById(R.id.idNomeCliente)
    }
}
...
//class Adapter(private val listClientes: List<ClienteEntity>, private val context: Context) :
//    RecyclerView.Adapter<Adapter.ClienteViewHolder>() {
